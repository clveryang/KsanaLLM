...
class DeepSeekV31ToolParser(ToolParser):
    def __init__(self, tokenizer: AnyTokenizer):
        ...
        self.tool_call_end_start_tokens: str = "<｜tool▁call▁end｜><｜tool▁call▁begin｜>"
    ...
    def extract_tool_calls_streaming(
        ...
        try:
            ...
            # case -- the current tool call is being closed.
                ...
                # To parser "<｜tool▁call▁begin｜>funtion_name<｜tool▁sep｜>function_args<｜tool▁call▁end｜>"
                # in one step.
                ...
                # To parser "funtion_name<｜tool▁sep｜>function_args<｜tool▁call▁end｜>" in one step.
